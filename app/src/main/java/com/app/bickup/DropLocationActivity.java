    ...
    public void onClick(View view) {
        ...
        switch (id) {
            ...
            case R.id.btn_confirm_booking:
                ...
                Log.d("TAGS","Drop Address  : "+GloableVariable.Tag_pickup_location_address);
                Log.d("TAGS","Drop type : "+GloableVariable.Tag_drop_home_type);
                Log.d("TAGS","Drop Villa no : "+GloableVariable.Tag_drop_villa_no);


                Log.d("TAGS","Drop Biiling name : "+GloableVariable.Tag_drop_building_name);
                Log.d("TAGS","Drop Floor no : "+GloableVariable.Tag_drop_floor_number);
                Log.d("TAGS","Drop Unit no : "+GloableVariable.Tag_drop_unit_number);


                Log.d("TAGS","Drop Contact type : "+GloableVariable.Tag_drop_Contact_type);
                Log.d("TAGS","Drop contact_name : "+GloableVariable.Tag_drop_contact_name);
                Log.d("TAGS","Drop contact_no : "+GloableVariable.Tag_drop_contact_number);
                Log.d("TAGS","Drop comment : "+GloableVariable.Tag_drop_comments);
