...
import com.app.bickup.model.Helper;
...
public class BookingDetailsFragment extends Fragment implements View.OnClickListener, GoodsImagesInterface {
    ...
    public void onResume() {
        ...
        // String ss=ja.toString();
        // ss.replace("\"","");
        // GloableVariable.Tag_type_of_goods=ja.toString()];
    ...
    private void initializeViews(View view) {
        ...
        if (help.equals("2")) {
            ...
            hep_arr = new JSONArray();
            JSONObject obj;
            for (Helper h : list_helper) {
                if (h.getHelper_person_count().equals("2")) {
                    obj = new JSONObject();
                    try {
                        obj.put("helper_id", h.getHelper_id());
                        obj.put("price", h.getHelper_price());
            ...
            Log.d("TAGS", "Helper Array -2" + hep_arr.toString());
        ...
        if (help.equals("1")) {
            ...
            Log.d("TAGS", "Helper Array - 1" + hep_arr.toString());
        }
        if (help.equals("0")) {
            img_helpers.setVisibility(View.GONE);
            hep_arr = new JSONArray();
            helper_prices= String.valueOf(0.00);
            Log.d("TAGS", "Helper Array - 0" + hep_arr.toString());
...
*/
        ...
        txt_booking_id.setText("#"+GloableVariable.Tag_booking_id);
...
*/
    ...
    private void editProfile() {
        ...
        Ion.with(this)
                ...
                .setMultipartParameter("file", array_ImageBitmap.toString())
                .setMultipartParameter("pickup_location_address", GloableVariable.Tag_pickup_location_address)
                ...
                .setMultipartParameter("helper", hep_arr.toString())
                .setMultipartParameter("type_of_goods", ja.toString())
                .setMultipartParameter("ride_description", GloableVariable.Tag_Good_Details_Description)

                .setMultipartParameter("distance", GloableVariable.Tag_distance)

                .setMultipartParameter("pickup_time_type", GloableVariable.Tag_Good_Details_Comming_time_type)
                .setMultipartParameter("pickup_time", GloableVariable.Tag_Good_Details_Comming_Date_time)
