...
import static com.app.bickup.LoginActivity.REQUEST_LOGIN;
            ...
            case R.id.btn_confirm_booking:
                ...
                if(validateFields()){
                    ...
                    if((boolean)liMe.getTag()){
                      ...
                      contactPersonName=  edtContactPersonname.getText().toString().trim();
                ...
                Log.d("TAGS","Pickup Address  : "+GloableVariable.Tag_pickup_location_address);
                Log.d("TAGS","Pickup type : "+GloableVariable.Tag_pickup_home_type);
                Log.d("TAGS","Pickup Villa no : "+GloableVariable.Tag_pickup_villa_no);


                Log.d("TAGS","Pickup Biiling name : "+GloableVariable.Tag_pickup_building_name);
                Log.d("TAGS","Pickup Floor no : "+GloableVariable.Tag_pickup_floor_number);
                Log.d("TAGS","Pickup Unit no : "+GloableVariable.Tag_pickup_unit_number);


                Log.d("TAGS","Pickup Contact type : "+GloableVariable.Tag_pickup_Contact_type);
                Log.d("TAGS","Pickup contact_name : "+GloableVariable.Tag_pickup_contact_name);
                Log.d("TAGS","Pickup contact_no : "+GloableVariable.Tag_pickup_contact_number);
                Log.d("TAGS","Pickup comment : "+GloableVariable.Tag_pickup_comments);
